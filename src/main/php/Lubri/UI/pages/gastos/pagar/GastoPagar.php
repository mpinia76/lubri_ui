<?php
namespace Lubri\UI\pages\gastos\pagar;
...
class GastoPagar extends LubriPage{
...
//
	...
	protected function parseXTemplate(XTemplate $xtpl){
		...
		$xtpl->assign( "lbl_pendiente", $this->localize( "forma.pago.pendiente") );
			...
			$xtpl->assign( "linkPagarEfectivo", $this->getLinkActionPagarGasto($this->getGasto(), LubriUtils::getCuentaUnica(), $this->getBackTo()) );
