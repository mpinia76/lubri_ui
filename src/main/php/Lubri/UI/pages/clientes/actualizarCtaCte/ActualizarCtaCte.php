<?php
namespace Lubri\UI\pages\clientes\actualizarCtaCte;


use Lubri\UI\service\finder\ClienteFinder;

use Lubri\UI\service\finder\CuentaFinder;
...
class ActualizarCtaCte extends LubriPage{
	...
	public function __construct(){
		...
		/*if( LubriUIUtils::isCajaSelected() )
			$this->destino = LubriUIUtils::getCaja();*/
