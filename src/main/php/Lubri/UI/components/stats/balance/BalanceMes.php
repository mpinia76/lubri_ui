...
class BalanceMes extends RastyComponent{
	...
	protected function parseXTemplate(XTemplate $xtpl){
		...
		/*$xtpl->assign("gastos",  LubriUIUtils::formatMontoToView($balance["gastos"]) );
		$xtpl->assign("pagos",  LubriUIUtils::formatMontoToView($balance["pagos"]) );*/
		$xtpl->assign("ventas",  LubriUIUtils::formatMontoToView($saldos["ventas"]) );
		//$xtpl->assign("comisiones",  LubriUIUtils::formatMontoToView($balance["comisiones"]) );
