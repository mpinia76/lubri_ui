...
namespace Lubri\UI\components\form\venta;

use Lubri\UI\service\finder\ClienteFinder;
use Lubri\UI\service\finder\VentaFinder;

use Lubri\UI\service\finder\TipoProductoFinder;

use Lubri\UI\service\finder\MarcaProductoFinder;

use Lubri\UI\service\finder\ProductoFinder;
use Lubri\UI\service\finder\ComboFinder;
...
class VentaForm extends Form{
	...
	public function __construct(){
        ...
        $this->addProperty("patente");
        $this->addProperty("marca");
        $this->addProperty("km");
        $this->addProperty("proxima");
	...
	protected function parseXTemplate(XTemplate $xtpl){
        ...
        $xtpl->assign("lbl_ultimasVentas", $this->localize("venta.autos") );
		$xtpl->assign("lbl_observaciones", $this->localize("venta.observaciones") );
        $xtpl->assign("lbl_patente", $this->localize("venta.patente") );
        $xtpl->assign("lbl_marca", $this->localize("venta.marca") );
        $xtpl->assign("lbl_km", $this->localize("venta.km") );
        $xtpl->assign("lbl_proxima", $this->localize("venta.proxima") );
	...
	//agrego los productos mÃ¡s vendidos como accesos rÃ¡pidos a agregar
        ...
        $xtpl->assign("linkSeleccionarCliente", $this->getLinkActionSeleccionarCliente() );
    ...
    public function getVentaFinderClazz(){

        return get_class( new VentaFinder() );

    }

    public function getLinkActionSeleccionarCliente(){

        return LinkBuilder::getActionAjaxUrl( "SeleccionarClienteJson") ;
    ...
    public function getUltimasVentas(){
        ...
        $ventas = UIServiceFactory::getUIVentaService()->getList( new UIVentaCriteria());
