...
namespace Lubri\UI\components\form\cliente;
...
use Lubri\Core\model\Sexo;

use Lubri\Core\model\TipoDocumento;
...
class ClienteForm extends Form{
	...
	public function getSexos(){
		...
		return LubriUIUtils::localizeEntities(Sexo::getItems());
	}

	public function getTiposDocumento(){

		return LubriUIUtils::localizeEntities(TipoDocumento::getItems());
	}
