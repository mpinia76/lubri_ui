...
//		//TODO esto setearlo en el .rasty
	...
	public function getMenuGroups( $item ){
		...
		if ($movimientoClass=='Lubri\Core\model\MovimientoVenta') {
	...
	public function getHeaderContent(){
		...
		return 'Bruto: <strong>'.LubriUIUtils::formatMontoToView($service->getTotales($criteria)).'</strong> Neto: <strong>'.LubriUIUtils::formatMontoToView($service->getGanancias($criteria)).'</strong>';
	}
