...
use Lubri\UI\components\grid\formats\GridPrecioListaFormat;
use Lubri\UI\components\grid\formats\GridPrecioEfectivoFormat;
use Lubri\UI\components\grid\formats\GridPorcentajeFormat;
...
//		//TODO esto setearlo en el .rasty
	...
	public function getHeaderContent(){
		...
		return 'Total: '.LubriUIUtils::formatMontoToView($service->getTotales($filter->getCriteria()));
	}
