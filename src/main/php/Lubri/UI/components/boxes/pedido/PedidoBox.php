...
namespace Lubri\UI\components\boxes\pedido;
...
use Lubri\Core\model\EstadoPedido;
...
class PedidoBox extends RastyComponent{
	...
	protected function parseXTemplate(XTemplate $xtpl){
		...
		$xtpl->assign( "monto", LubriUIUtils::formatMontoToView( $pedido->getMonto() ) );
		$xtpl->assign( "observaciones", $this->getPedido()->getObservaciones() );
		$xtpl->assign( "fechaHora", LubriUIUtils::formatDateTimeToView($this->getPedido()->getFechaHora()) );

		$xtpl->assign( "estado", $this->localize( EstadoPedido::getLabel( $pedido->getEstado()) ) );

		if( $pedido->isRecibido() ){
			$recibido = LubriUIUtils::formatDateTimeToView($this->getPedido()->getFechaHoraRecibido());
		...
		$xtpl->assign( "total", LubriUIUtils::formatMontoToView( $pedido->getMonto() ) );
