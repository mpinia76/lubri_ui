...
namespace Lubri\UI\components\boxes\presupuesto;
...
class PresupuestoBox extends RastyComponent{
	...
	protected function parseXTemplate(XTemplate $xtpl){
		...
		$xtpl->assign( "monto", LubriUIUtils::formatMontoToView( $this->getPresupuesto()->getMonto() ) );



		$xtpl->assign( "observaciones", $this->getPresupuesto()->getObservaciones() );
		$xtpl->assign( "fecha", LubriUIUtils::formatDateTimeToView($this->getPresupuesto()->getFecha()) );
		...
		$xtpl->assign( "total", LubriUIUtils::formatMontoToView( $presupuesto->getMonto() ) );
